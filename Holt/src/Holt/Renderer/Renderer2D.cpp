...
namespace Holt {
	...
	struct Renderer2DData
	{
		...
		static const uint32_t MaxTextureSlots = 32; // TODO: Check in GPU
	...
	void Holt::Renderer2D::DrawRotatedQuad(const glm::mat4& transform, const glm::vec4 color)
	{
		HL_PROFILE_FUNCTION();
	...
	void Holt::Renderer2D::DrawRotatedQuad(const glm::mat4& transform, const Ref<Texture2D>& texture, float tilingFactor, const glm::vec4& tintColor)
	{
		HL_PROFILE_FUNCTION();
	...
	void Holt::Renderer2D::NextBatch()
	{
		Flush();
		StartBatch();
	}
